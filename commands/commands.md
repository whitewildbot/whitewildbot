...
Имя может быть установлено длиной до 90 символов.
![Image](images/setname.jpg)
...
Местоимения может быть установлены длиной до 30 символов.
![Image](images/setpronouns.jpg)

#### !setlocation (локация)
Это установит ваше местоположение в боте, это ни на что не влияет.
Без параметров локация будет удалена с вашего профиля.
Локация может быть установлена длиной до 240 символов.
![Image](images/setlocation.jpg)

#### !setbirthday (мм.дд.гггг/день мес., год(только на англ.))
Это установит ваш день рождения в боте, это ни на что не влияет.
Без параметров ваш день рождение будет удален с вашего профиля.
![Image](images/setbirthday.jpg)
...
Описание может быть установлено длиной до 256 символов.
![Image](images/setabout.jpg)
...
Отправив команду без картинки, бот её удалит.
![Image](images/setpicture.jpg)

#### !whois
Этой командой можно посмотреть профиль в боте свой или чей-то ответив на сообщение другого пользователя с этой командой.
Команда имеет несколько сокращений: *я*, *кто ты*, *кто я*
![Image](images/whois.jpg)
...
После в вашем профиле появится канал который вы добавили.
![Image](images/setchannel_and_verifychannel.jpg)
...
Отправив команду без ответа, бот удалит стикер пак с профиля.
![Image](images/addstickerset.jpg)
...
Отправив команду без ответа, бот удалит музыку с профиля.
![Image](images/setmusic.jpg)

#### !family (<создать>/пригласить/выгнать/покинуть/распустить/принять) (<название>)
Команда имеет одно сокращение: *семья*
![Image](images/family.jpg)
Это семья. Она может вместить в себя до 15 участников одновременно.
Создать семью можно командой *семья создать <название>*.
![Image](images/family_creation.jpg)
Отправить приглашение можно командой *семья пригласить* ответом на сообщение пользователя.
![Image](images/family_invite.jpg)
Принять приглашение можно командой *семья принять*.
![Image](images/family_accept.jpg)
Покинуть семью можно командой *семья покинуть*
![Image](images/family_leave.jpg)
Так же лидер семьи может выгнать участников, командой *семья выгнать* ответив на сообщение пользователя.
![Image](images/family_kick.jpg)
Чтобы удалить семью, используйте команду *семья распустить*.
![Image](images/family_delete.jpg)

#### !setsteam [Ссылка на ваш аккаунт в стим]
После добавления, в вашем профиле в боте будет писать вот что вы играете в данный момент.
![Image](images/setsteam.jpg)
